...
<head>
  ...
  <title>Search String | Search any string in any website</title>
  <meta name="description" content="Search any string in any website" />
    ...
    <!--[if IE]>
      <div class="alert alert-warning">
        ...
        <header class="header" role="header">
          <div class="container">
            <h1 class="title"><a href="<?php echo (!empty($_SERVER['HTTPS']) ? 'https' : 'http') . '://' . $_SERVER['SERVER_NAME'] . dirname($_SERVER['PHP_SELF']); ?>">Search String Tool</a></h1>
